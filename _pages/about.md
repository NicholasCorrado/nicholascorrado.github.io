...
Recently, my research has focused on (1) understanding the role of data augmentation in the context of RL and 
(2) demonstrating how adaptive, off-policy sampling can make on-policy learning more data efficient.
Ultimate, my goal is to make RL a more viable tool for real-world tasks. 
...
During my first year, I worked with [Jignesh Patel's](https://jigneshpatel.org) group building [Hustle](https://github.com/UWHustle/hustle), 
